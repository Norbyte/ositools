...
BEGIN_BITMASK_NS(ecl, VisualSystemSetFlags, uint32_t)
	EV(Reflecting, 0x200)
...
BEGIN_BITMASK_NS(ecl, TaskErrorFlags, uint32_t)
	EV(NotEnoughAP, 0x1)
	EV(CantReach, 0x2)
...
BEGIN_BITMASK_NS(ecl, CharacterTaskFlags, uint32_t)
	EV(IsExecuting, 0x1)
...
BEGIN_ENUM_NS(ecl, CursorType, uint32_t)
	EV(CursorSystem, 0)
	EV(CursorArrow, 1)
...
BEGIN_ENUM_NS(ecl, CharacterSoundObjectType, uint8_t)
	EV(General, 0)
	EV(MainHand, 1)
	EV(OffHand, 2)
END_ENUM_NS()
...
BEGIN_ENUM_NS(esv, MovementStateType, uint32_t)
	EV(Movement, 2)
	EV(MoveTo, 3)
END_ENUM_NS()


BEGIN_ENUM_NS(esv, ActionStateType, uint32_t)
	EV(Attack, 2)
	EV(Die, 3)
	EV(Hit, 4)
	EV(Idle, 5)
...
BEGIN_ENUM_NS(esv, TaskType, uint32_t)
	EV(MoveToLocation, 0)
	EV(MoveToObject, 1)
	EV(Flee, 2)
	EV(MoveInRange, 3)
...
BEGIN_BITMASK_NS(esv, StatusControllerFlags, uint32_t)
	EV(Dying, 0x1)
...
BEGIN_BITMASK_NS(ecl, DeactivateEquipmentSlotMask, uint16_t)
...
BEGIN_BITMASK_NS(ecl, DeactivateVisualSetSlotMask, uint16_t)
...
BEGIN_ENUM_NS(esv, CharacterTransformType, uint32_t)
	EV(TransformToTemplate, 1)
	EV(TransformToCharacter, 2)
END_ENUM_NS()

BEGIN_BITMASK_NS(esv, CharacterTransformFlags, uint32_t)
...
BEGIN_BITMASK_NS(esv, ItemTransformFlags, uint32_t)
	EV(ReplaceScripts, 0x01)
	EV(ReplaceStats, 0x02)
	EV(Immediate, 0x04)
END_ENUM_NS()
...
BEGIN_BITMASK_NS(ecl, CharacterFlags, uint64_t)
	EV(IsPlayer, 0x01)
	EV(InParty, 0x02)
	EV(Activated, 0x04)
	EV(Dead, 0x8)
...
BEGIN_BITMASK_NS(ecl, CharacterFlags2, uint8_t)
...
BEGIN_BITMASK_NS(ecl, CharacterFlags3, uint8_t)
...
BEGIN_BITMASK_NS(ecl, ItemPhysicsFlags, uint8_t)
	EV(PhysicsDisabled, 0x01)
	EV(RequestRaycast, 0x02)
	EV(RequestWakeNeighbours, 0x04)
END_ENUM_NS()

BEGIN_BITMASK_NS(ecl, ItemFlags, uint64_t)
	EV(Activated, 0x01)
...
BEGIN_BITMASK_NS(ecl, ItemFlags2, uint8_t)
...
BEGIN_BITMASK_NS(ecl, SceneryFlags, uint64_t)
	EV(CanShootThrough, 0x10)
	EV(Walkable, 0x20)
...
BEGIN_BITMASK_NS(ecl, SceneryRenderFlags, uint32_t)
