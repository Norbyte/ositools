...
struct Object : public Noncopyable<Object>
{
	...
	static bool LuaFallbackGet(lua_State* L, lua::LifetimeHolder const& lifetime, Object* object, FixedString const& prop);
	static bool LuaFallbackSet(lua_State* L, lua::LifetimeHolder const& lifetime, Object* object, FixedString const& prop, int index);
