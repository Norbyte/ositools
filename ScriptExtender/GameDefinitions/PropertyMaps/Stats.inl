...
BEGIN_CLS(stats::TreasureSubTableDescription::DropCount)
P(Amount)
P(Chance)
END_CLS()


BEGIN_CLS(stats::TreasureSubTableDescription::Category)
P(Index)
P(Frequency)
P_REF(Frequencies)
P_REF(CurrentFrequencies)
P(IsTreasureTable)
P(IsTreasureTable2)
END_CLS()


BEGIN_CLS(stats::TreasureSubTableDescription)
P_REF(Categories)
P_REF(CategoryFrequencies)
P(TotalFrequency)
P_REF(DropCounts)
P_REF(Amounts)
P(TotalCount)
...
BEGIN_CLS(CustomDamageTypeDescriptor)
P_RO(DamageTypeId)
P_RO(EnumLabel)
P(Name)
P(NameHandle)
P(NameExtended)
P(NameExtendedHandle)
P(Description)
P(DescriptionHandle)
P(AmountAndTypeText)
P(AmountAndTypeTextHandle)
P(ColorCode)
P_GETTER(Callbacks, GetCallbacks)
END_CLS()

BEGIN_CLS(CustomDamageTypeCallbacks)
P_RO(DamageTypeId)
P(GetResistanceCallback)
P(GetDamageBoostCallback)
P(GetArmorDamageCallback)
P(GetMagicArmorDamageCallback)
END_CLS()


BEGIN_CLS(CustomRequirementDescriptor)
P_RO(RequirementId)
P_RO(EnumLabel)
P(Description)
P(DescriptionHandle)
...
BEGIN_CLS(CustomRequirementCallbacks)
P_RO(RequirementId)
P(EvaluateCallback)
END_CLS()

BEGIN_CLS(CustomRequirementContext)
P_REF(ServerCharacter)
P_REF(ServerItem)
P_REF(ClientCharacter)
P_REF(ClientItem)
P_REF(ItemStats)
P_RO(SkillId)
P_REF(CharacterStats)
P_RO(IsInCombat)
P_RO(IsImmobile)
P_RO(HasCharges)
P_REF(Tags)
...
BEGIN_CLS(stats::ValueList)
P_RO(Name)
P_REF(Values)
END_CLS()

BEGIN_CLS(stats::LevelMap)
P_RO(ModifierListIndex)
P_RO(ModifierIndex)
P_RO(ValueListIndex)
P_RO(Name)
P_FUN(GetScaledValue, LuaGetScaledValue)
END_CLS()

BEGIN_CLS(stats::NamedElementManager<stats::ValueList>)
P_REF(Elements)
P_REF(NameToIndex)
P_FUN(GetByName, GetByName)
END_CLS()

BEGIN_CLS(stats::NamedElementManager<stats::ModifierList>)
P_REF(Elements)
P_REF(NameToIndex)
P_FUN(GetByName, GetByName)
END_CLS()

BEGIN_CLS(stats::NamedElementManager<stats::Modifier>)
P_REF(Elements)
P_REF(NameToIndex)
P_FUN(GetByName, GetByName)
END_CLS()
