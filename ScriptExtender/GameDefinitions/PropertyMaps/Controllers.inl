...
P(MousePos)
P(field_2C)
P_REF(TaskPrototypes)
P(DraggingObjectHandle)
P(Flags)
P_REF(CurrentTask)
P_REF(PreviewTask)
P_REF(ChosenTasks)
...
BEGIN_CLS(ecl::CharacterTask)
P_REF(BoundCharacter)
P_RO(ActionTypeId)
P(Flags)
P_REF(CurrentContext)
P_REF(SavedContext)
P(IsInPreviewMode)
P(RequestRun)
END_CLS()
...
BEGIN_CLS(ecl::CharacterTask::Context)
P(Position)
P(CurrentAP)
