...
P_RO(RefCount)
P_FUN(Play, LuaPlay)
P_FUN(Pause, LuaPause)
P_FUN(Stop, LuaStop)
P_FUN(StopImmediate, LuaStopImmediate)
P_FUN(ReloadParameters, LuaReloadParameters)
P_FUN(UpdateParametersFromResource, LuaUpdateEffectParametersFromEffectResource)
END_CLS()
