...
BEGIN_CLS(esv::CharacterBody)
P_RO(CurrentAnimation)
P_RO(AnimationFinshedEvent_M)
P(NextAnimation)
P(TimeOffset)
P(ForceStartAnimation)
P_REF(ActionState)
END_CLS()
...
P_RO(Team)
P_RO(Color)
P_RO(LevelTemplatePosition)
P_RO(AoOVelocityOverride)
P_RO(SomePositionOverride)
P_RO(NextCheckpointPosition)
P_REF(AI)
P(AnimationOverride)
P(WalkSpeedOverride)
P(RunSpeedOverride)
