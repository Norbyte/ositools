...
LUA_POLYMORPHIC(Trigger)
LUA_POLYMORPHIC(AreaTrigger)
LUA_POLYMORPHIC(esv::PointTriggerBase)
LUA_POLYMORPHIC(esv::AreaTriggerBase)
...
LUA_POLYMORPHIC(ecl::MovementState)
LUA_POLYMORPHIC(esv::ActionState)
LUA_POLYMORPHIC(ecl::ActionState)
LUA_POLYMORPHIC(esv::Task)
LUA_POLYMORPHIC(esv::GameAction)
LUA_POLYMORPHIC(ecl::SkillState)
LUA_POLYMORPHIC(esv::SkillState)
