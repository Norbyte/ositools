...
namespace dse
{
	...
	enum class ObjectType : uint32_t
	{
		...
		TerrainObject = 10,
		MeshProxy = 11,
		SoundVolumeTrigger = 12,
		Scene = 13,
		GrannyFile = 14,
		CustomStatsComponent = 15,
		CombatComponent = 16,
		ContainerComponent = 17,
		ContainerElementComponent = 18,
		GMJournalNode = 19,
		ClientCustomStatDefinitionComponent = 20,
		ClientEgg = 21,
		ClientCharacter = 22,
		ClientItem = 23,
		ClientProjectile = 24,
		ClientScenery = 25,
		ClientWallConstruction = 26,
		ClientWallBase = 27,
		ClientWallIntersection = 28,
		ClientInventory = 29,
		ClientInventoryView = 30,
		ClientAlignment = 31,
		ClientAlignmentData = 32,
		ClientGameAction = 33,
		ClientSkill = 34,
		ClientStatus = 35,
		ClientParty = 36,
		ClientOverviewMap = 37,
		ClientVignette = 38,
		ClientNote = 39,
		ClientPointTrigger = 40,
		ClientCullTrigger = 41,
		ClientCameraLockTrigger = 42,
		ClientRegionTrigger = 43,
		ClientSecretRegionTrigger = 44,
		ClientSoundVolumeTrigger = 45,
		ClientPointSoundTrigger = 46,
		ClientPointSoundTriggerDummy = 47,
		ClientSpectatorTrigger = 48,
		ClientAtmosphereTrigger = 49,
		ClientAiSeederTrigger = 50,
		ClientSurface = 51,
		ClientDummyGameObject = 52,
		ServerCustomStatDefinitionComponent = 53,
		ServerEgg = 54,
		ServerCharacter = 55,
		ServerItem = 56,
		ServerProjectile = 57,
		ServerInventory = 58,
		ServerInventoryView = 59,
		ServerParty = 60,
		ServerOverviewMap = 61,
		ServerVignette = 62,
		ServerNote = 63,
		ServerSurfaceAction = 64,
		ServerEocPointTrigger = 65,
		ServerEocAreaTrigger = 66,
		ServerStartTrigger = 67,
		ServerTeleportTrigger = 68,
		ServerEventTrigger = 69,
		ServerCrimeAreaTrigger = 70,
		ServerCrimeRegionTrigger = 71,
		ServerAtmosphereTrigger = 72,
		ServerAIHintAreaTrigger = 73,
		ServerMusicVolumeTrigger = 74,
		ServerSecretRegionTrigger = 75,
		ServerStatsAreaTrigger = 76,
		ServerSoundVolumeTrigger = 77,
		ServerRegionTrigger = 78,
		ServerExplorationTrigger = 79,
		Texture = 80,
		Shader = 81,
		IndexBuffer = 82,
		VertexBuffer = 83,
