...
#pragma pack(push, 1)
	...
	struct ObjectVisitor : public ProtectedGameObject<ObjectVisitor>
	{
		...
		virtual void VisitGuid(FixedString const&, void*, void*) = 0;
		virtual void VisitTranslatedString(FixedString const&, TranslatedString*, TranslatedString*) = 0;
		virtual void VisitSTDWString(FixedString const&, STDWString*, STDWString*) = 0;
		virtual void VisitSTDString(FixedString const&, STDString*, STDString*) = 0;
		virtual void VisitFixedString(FixedString const&, FixedString const&, FixedString&) = 0;
		...
		virtual void VisitObjectHandle(FixedString const&, void*, void*) = 0;
		virtual void VisitQuaternion(FixedString const&, float*, float*) = 0;
		virtual void VisitMatrix4x3(FixedString const&, float*, float*) = 0;
		virtual void VisitMatrix3x4(FixedString const&, float*, float*) = 0;
		virtual void VisitMatrix4x4(FixedString const&, float*, float*) = 0;
		virtual void VisitMatrix3x3(FixedString const&, float*, float*) = 0;
		virtual void VisitMatrix2x2(FixedString const&, float*, float*) = 0;
		virtual void VisitVector4Unaligned(FixedString const&, float*, float*) = 0;
		virtual void VisitVector4(FixedString const&, float*, float*) = 0;
		virtual void VisitVector3(FixedString const&, float*, float*) = 0;
		virtual void VisitVector2(FixedString const&, float*, float*) = 0;
