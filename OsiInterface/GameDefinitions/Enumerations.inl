...
BEGIN_ENUM(StatusType, uint32_t)
	...
	EV(Explode, 0x23)
	EV(Adrenaline, 0x24)
	EV(ShacklesOfPain, 0x25)
	EV(ShacklesOfPainCaster, 0x26)
	EV(WindWalker, 0x27)
	EV(DarkAvenger, 0x28)
	EV(Remorse, 0x29)
	EV(DecayingTouch, 0x2A)
	EV(Unhealable, 0x2B)
	EV(Flanked, 0x2C)
	EV(Channeling, 0x2D)
	EV(Drain, 0x2E)
	EV(LingeringWounds, 0x2F)
	EV(Infused, 0x30)
	EV(SpiritVision, 0x31)
	EV(Spirit, 0x32)
	EV(Damage, 0x33)
	EV(ForceMove, 0x34)
	EV(Climbing, 0x35)
	...
	EV(Combustion, 0x3A)
	EV(Polymorphed, 0x3B)
	EV(DamageOnMove, 0x3C)
	EV(DemonicBargain, 0x3D)
	EV(GuardianAngel, 0x3E)
	EV(Floating, 0x40)
	EV(Challenge, 0x41)
	EV(Disarmed, 0x42)
	EV(HealSharing, 0x43)
	EV(HealSharingCaster, 0x44)
	EV(ExtraTurn, 0x45)
	EV(ActiveDefense, 0x46)
	EV(Spark, 0x47)
	EV(PlayDead, 0x48)
	EV(Constrained, 0x49)
	EV(Effect, 0x4A)
