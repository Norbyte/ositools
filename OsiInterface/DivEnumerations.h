...
namespace osidbg
{
	...
	{
		AF_None = 1ull << 0,
		AF_FreezeImmunity = 1ull << 1,
		AF_BurnImmunity = 1ull << 2,
		AF_StunImmunity = 1ull << 3,
		AF_PoisonImmunity = 1ull << 4,
		AF_CharmImmunity = 1ull << 5,
		AF_FearImmunity = 1ull << 6,
		AF_KnockdownImmunity = 1ull << 7,
		AF_MuteImmunity = 1ull << 8,
		AF_ChilledImmunity = 1ull << 9,
		AF_WarmImmunity = 1ull << 10,
		AF_WetImmunity = 1ull << 11,
		AF_BleedingImmunity = 1ull << 12,
		AF_CrippledImmunity = 1ull << 13,
		AF_BlindImmunity = 1ull << 14,
		AF_CursedImmunity = 1ull << 15,
		AF_WeakImmunity = 1ull << 16,
		AF_SlowedImmunity = 1ull << 17,
		AF_DiseasedImmunity = 1ull << 18,
		AF_InfectiousDiseasedImmunity = 1ull << 19,
		AF_PetrifiedImmunity = 1ull << 20,
		AF_DrunkImmunity = 1ull << 21,
		AF_SlippingImmunity = 1ull << 22,
		AF_FreezeContact = 1ull << 23,
		AF_BurnContact = 1ull << 24,
		AF_StunContact = 1ull << 25,
		AF_PoisonContact = 1ull << 26,
		AF_ChillContact = 1ull << 27,
		AF_Torch = 1ull << 28,
		AF_Arrow = 1ull << 29,
		AF_Unbreakable = 1ull << 30,
		AF_Unrepairable = 1ull << 31,
		AF_Unstorable = 1ull << 32,
		AF_Grounded = 1ull << 33,
		AF_HastedImmunity = 1ull << 34,
		AF_TauntedImmunity = 1ull << 35,
		AF_SleepingImmunity = 1ull << 36,
		AF_AcidImmunity = 1ull << 37,
		AF_SuffocatingImmunity = 1ull << 38,
		AF_RegeneratingImmunity = 1ull << 39,
		AF_DisarmedImmunity = 1ull << 40,
		AF_DecayingImmunity = 1ull << 41,
		AF_ClairvoyantImmunity = 1ull << 42,
		AF_EnragedImmunity = 1ull << 43,
		AF_BlessedImmunity = 1ull << 44,
		AF_ProtectFromSummon = 1ull << 45,
		AF_Floating = 1ull << 46,
		AF_DeflectProjectiles = 1ull << 47,
		AF_IgnoreClouds = 1ull << 48,
		AF_MadnessImmunity = 1ull << 49,
		AF_ChickenImmunity = 1ull << 50,
		AF_IgnoreCursedOil = 1ull << 51,
		AF_ShockedImmunity = 1ull << 52,
		AF_WebImmunity = 1ull << 53,
		AF_LootableWhenEquipped = 1ull << 54,
		AF_PickpocketableWhenEquipped = 1ull << 55,
