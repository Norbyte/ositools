...
namespace dse
{
	...
	EnumInfo<StatusType>::Label const EnumInfo<StatusType>::Values[] = {
		...
		{ StatusType::InfectiousDiseased, "INFECTIOUS_DISEASED" },
		...
		{ StatusType::ShacklesOfPain, "SHACKLES_OF_PAIN" },
		{ StatusType::ShacklesOfPainCaster, "SHACKLES_OF_PAIN_CASTER" },
		{ StatusType::WindWalker, "WIND_WALKER" },
		{ StatusType::DarkAvenger, "DARK_AVENGER" },
		{ StatusType::Remorse, "REMORSE" },
		{ StatusType::DecayingTouch, "DECAYING_TOUCH" },
		{ StatusType::Unhealable, "UNHEALABLE" },
		{ StatusType::Flanked, "FLANKED" },
		{ StatusType::Channeling, "CHANNELING" },
		{ StatusType::Drain, "DRAIN" },
		{ StatusType::LingeringWounds, "LINGERING_WOUNDS" },
		{ StatusType::Infused, "INFUSED" },
		{ StatusType::SpiritVision, "SPIRIT_VISION" },
		{ StatusType::Spirit, "SPIRIT" },
		{ StatusType::Damage, "DAMAGE" },
		{ StatusType::ForceMove, "FORCE_MOVE" },
		{ StatusType::Climbing, "CLIMBING" },
		{ StatusType::Incapacitated, "INCAPACITATED" },
		{ StatusType::InSurface, "INSURFACE" },
		{ StatusType::SourceMuted, "SOURCE_MUTED" },
		{ StatusType::Overpowered, "OVERPOWER" },
		{ StatusType::Combustion, "COMBUSTION" },
		{ StatusType::Polymorphed, "POLYMORPHED" },
		{ StatusType::DamageOnMove, "DAMAGE_ON_MOVE" },
		{ StatusType::DemonicBargain, "DEMONIC_BARGAIN" },
		{ StatusType::GuardianAngel, "GUARDIAN_ANGEL" },
		// THICK_OF_THE_FIGHT deleted
		{ StatusType::Floating, "FLOATING" },
		{ StatusType::Challenge, "CHALLENGE" },
		{ StatusType::Disarmed, "DISARMED" },
		{ StatusType::HealSharing, "HEAL_SHARING" },
		{ StatusType::HealSharingCaster, "HEAL_SHARING_CASTER" },
		{ StatusType::ExtraTurn, "EXTRA_TURN" },
		{ StatusType::ActiveDefense, "ACTIVE_DEFENSE" },
		{ StatusType::Spark, "SPARK" },
		{ StatusType::PlayDead, "PLAY_DEAD" },
		{ StatusType::Constrained, "CONSTRAINED" },
		{ StatusType::Effect, "EFFECT" },
		{ StatusType::Deactivated, "DEACTIVATED" },
		{ StatusType::TutorialBed, "TUTORIAL_BED" }
	};
	...
	EnumInfo<StatCharacterFlags>::Label const EnumInfo<StatCharacterFlags>::Values[] = {
		...
		{ StatCharacterFlags::SCF_IsSneaking, "IsSneaking" },
