...
Copy-Item x64\Release\OsiExtenderEoCApp.pdb -Destination LatestBuildPDB\OsiExtenderEoCApp.pdb
Copy-Item x64\ReleaseExtensionsOnly\OsiExtenderEoCPlugin.pdb -Destination LatestBuildPDB\OsiExtenderEoCPlugin.pdb
Copy-Item x64\Release\CrashReporter.exe -Destination LatestBuildPDB\CrashReporter.exe
Copy-Item x64\Release\OsiExtenderEoCApp.dll -Destination LatestBuildPDB\OsiExtenderEoCApp.dll
Copy-Item x64\ReleaseExtensionsOnly\OsiExtenderEoCPlugin.dll -Destination LatestBuildPDB\OsiExtenderEoCPlugin.dll
